...
api_key = "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"
...
def msg():
    ...
    if bill_info['expense'] != None and int(bill_info['expense']) < int(total_claim_amount) :
        ...
        print(f'Inference Time unvalid amount {inference_time}')
        ...
        end_time = time.time()
        inference_time = end_time - start_time
        print(f'Inference Time unvalid consultation {inference_time}')
